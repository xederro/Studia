...
- czynności po których wykonaniu możemy stwierdzić ze w chwili pomiaru dokonanego w określonych warunkach, przy zastosowaniu określonych środków i wykonaniu odpowiednich czynności wielkość mierzona x miała wartość $$ a \leq x \leq b $$<- wynik pomiarowy 
...
graph TD;
 ...
 Wskazy-podziałki --> Przyrządy-pomiarowe;
 Przyrządy-pomiarowe --> 1.Skalowanie;
 Wskazy-podziałki --> 2.Wzorcowanie;
 2.Wzorcowanie --> Świadectwo-wzorcowania;
 2.Wzorcowanie --> Tabela-poprawek;
 Wzorzec --> 1.Skalowanie;
 Wzorzec --> 2.Wzorcowanie;
 2.Wzorcowanie --> Tabela-poprawek;
 Tabela-poprawek --> Wskazy-podziałki;
 Tabela-poprawek --> 3.Adjustacja;
