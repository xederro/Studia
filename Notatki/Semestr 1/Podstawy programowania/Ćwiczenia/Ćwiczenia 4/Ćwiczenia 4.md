![[Notatki/Semestr 1/Podstawy programowania/Ćwiczenia/Ćwiczenia 4/Cwiczenia_4.pdf]]
![[Notatki/Semestr 1/Podstawy programowania/Ćwiczenia/Ćwiczenia 4/Słowne nazwy typów.pdf]]
1. 
...
2. 
   ![[Notatki/Semestr 1/Podstawy programowania/Ćwiczenia/Ćwiczenia 4/lista4.cpp]]
3. 
   ```cpp
	   printf("%d, %d\n", tab2[w][k], *(*(tab2 + w) + k));
	   printf("%d, %d\n", tab3[w][k], *(*(tab3 + w) + k));
